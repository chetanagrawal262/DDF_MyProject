...
public class LandownerImportPage extends BasePage {
	...
	By percentOwnership = By.xpath("//span[contains(@id,'idYalImport_SourceCols') and text()='Percent Ownership: ']/..//input[contains(@id,'Dest_Input')] | //input[contains(@id,'Pct_Ownership') and @type='text']");
	...
	By addressLine3 = By.xpath("//span[contains(@id,'idYalImport_SourceCols') and text()='Address Line 3: ']/..//input[contains(@id,'Dest_Input')] | //input[contains(@id,'ENTITY_Address_Line_3') and @type='text']");
	...
	By zip = By.xpath("//span[contains(@id,'idYalImport_SourceCols') and text()='Zipcode: ']/..//input[contains(@id,'Dest_Input')] | //input[contains(@id,'ENTITY_Zip_Code') and @type='text']");
		...
		SoftAssert assertion = new SoftAssert();
				...
				util.dummyWait(2);
				 ...
				 Set<String> windowId = driver.getWindowHandles(); // get window id of current window
					...
					assertion.assertEquals(getPercentOwnership(), map.get("Percent Ownership").trim(), "Ownership Percentage mismatched");
					ExtentTestManager.log("Ownership Percentage matched : " +getPercentOwnership());
					...
					assertion.assertEquals(getZip(), map.get("Zipcode").trim(), "Zip mismatched");
