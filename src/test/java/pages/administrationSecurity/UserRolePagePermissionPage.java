...
public class UserRolePagePermissionPage extends BasePage {
	...
	public void selectRolePermission(Map<String, String> map, String testcaseName) {
		...
		try {
			...
			log("STEP 4:  Verify Project Details Write rules:", Status.PASS);
		} catch (Exception e) {
			log("STEP 4:  Failed to Verify Project Details Write rules:", Status.FAIL);
			throw new RuntimeException("Failed in step 4:  Failed to Verify Project Details Write rules:");
		}

		try {
			navigateUserRoles();
			verifyProjectDetailsRead();
			log("STEP 5:  Verify Project Details Read rules:", Status.PASS);
		} catch (Exception e) {
			log("STEP 5:  Failed to Verify Project Details Read rules:", Status.FAIL);
			throw new RuntimeException("Failed in step 5:  Failed to Verify Project Details Read rules:");
		}

		try {
			navigateUserRoles();
			verifyProjectDetailsNA();
			log("STEP 6:  Verify Project Details NA rules:", Status.PASS);
		} catch (Exception e) {
			log("STEP 6:  Failed to Verify Project Details NA rules:", Status.FAIL);
			throw new RuntimeException("Failed in step 6:  Failed to Verify Project Details NA rules:");
		}
		try {
			...
			util.click(savePermission);
			util.dummyWait(1);
			log("STEP 7:  Select W permission for Project Details:", Status.PASS);
		} catch (Exception e) {
			log("STEP 7:  Failed to Select W permission for Project Details:", Status.FAIL);
			throw new RuntimeException("Failed in step 7:  Failed to Select W permission for Project Details:");
		}
		...
		try {
			...
			selectRoleDD(map.get(Excel.Roles));
			clickOnDuplication();
			log("STEP 8:  User can click on Duplication Permission", Status.PASS);
		} catch (Exception e) {
			log("STEP 8:  User can not click on Duplication Permission", Status.FAIL);
			throw new RuntimeException("Failed in step 8:  User can not click on Duplication Permission");
		}
		try {
			saveUserRole(map.get(Excel.NewRoles));
			log("STEP 9:  User can save Duplication User Role", Status.PASS);
		} catch (Exception e) {
			log("STEP 9:  User can not save Duplication User Role", Status.FAIL);
			throw new RuntimeException("Failed in step 9:  User can not save Duplication User Role");
		}
		try {
			clickOnSave();
			log("STEP 10:  User can click on Save", Status.PASS);
		} catch (Exception e) {
			log("STEP 10:  User can not click on Save", Status.FAIL);
			throw new RuntimeException("Failed in step 10: User can not click on Save ");
		}
	...
	public void addNewPermission(Map<String, String> map, String testcaseName) {
		try {
			clickOnAddNew();
			log("STEP 11:  User can click on Add New", Status.PASS);
		} catch (Exception e) {
			log("STEP 11:  User can not click on Add New", Status.FAIL);
			throw new RuntimeException("Failed in step 11: ");
		}
		try {
			setNewRoles(map.get(Excel.NewRoles));
			log("STEP 12:  User can add New Roles", Status.PASS);
		} catch (Exception e) {
			log("STEP 12:  User can not add New Roles", Status.FAIL);
			throw new RuntimeException("Failed in step 12:  ");
		}
		try {
			clickOnSaveNewRole();
			log("STEP 13:  User can click on Save New Roles", Status.PASS);
		} catch (Exception e) {
			log("STEP 13:  User can not click on Save New Roles", Status.FAIL);
			throw new RuntimeException("Failed in step 13: ");
		}
		try {
			clickOnRemove();
			log("STEP 14:  User can click on Remove", Status.PASS);
		} catch (Exception e) {
			log("STEP 14:  User can not click on Remove", Status.FAIL);
