...
public class AddStructuresRecordPage  extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String AGREEMENT_NUMBER;

	public AddStructuresRecordPage(WebDriver driver) {
		this.driver = driver;
   ...
   By btnAddRecord = By.xpath("//img[contains(@id,'_customFields2') and @alt='Add new record']");
   ...
   public void NavigateToStructure() {
	   util.waitUntilElementDisplay(navStructure);
	   util.click(navStructure);
   ...
   public void selectISAResidence(String value) {
   ...
   public void AddStructureRecord(Map<String, String> map, String testcaseName) {
	       ...
	       try {
		    	 ...
		    	 try {
		    		 selectISAResidence(map.get(Excel.ISAResidence));
		    		log("STEP 2: User can select ISA Residence ", Status.PASS);
		 		 } catch (Exception e) {
		 			log("STEP 2:  User cannot select ISA Residence ", Status.FAIL);
		    	 ...
		    	 try {
		    		 By isaValue = By.xpath("//table[contains(@id,'_radYALGridControl')]/..//a[text()='ISAResidence']/../../../..//td[text()='"+map.get(Excel.ISAResidence)+"']");
