...
public class DeleteDocumentVestingOwnershipRecordPage extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String AGREEMENT_NUMBER;

	public DeleteDocumentVestingOwnershipRecordPage(WebDriver driver) {
		this.driver = driver;
	...
	By btnDelete = By.xpath("//input[contains(@id,'VESTING_radYALGridControl_ctl00_ctl04_gbcDeleteAlignment')]");
	...
	By changesSavedSuccessfully = By.xpath("//span[text()='Changes saved successfully!']");
	 ...
	 public void ClickonOk() 
	 {
         ...
         public void DeleteDocumentVestingOwnershipRecord(String testcaseName) {
