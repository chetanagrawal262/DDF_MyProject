...
public class DeleteTitleIssuesRecordPage extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String AGREEMENT_NUMBER;

	public DeleteTitleIssuesRecordPage(WebDriver driver) {
		this.driver = driver;
		util = new TestUtil(driver);
		commonFunction = new CommonFunction(driver);
	}
	
	By btnDelete = By.xpath("//input[contains(@id,'YALTITLEISSUES_radYALGridControl_ctl00_ctl04_gbcDeleteAlignment')]");
 ...
 public void ClickonCancle() {
  ...
  public void ClickonOk()  {
     ...
     public void DeleteTitleIssuesRecord(String testcaseName) {
