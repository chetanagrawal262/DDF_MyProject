...
public class DeleteLesseeRecordPage extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String AGREEMENT_NUMBER;

	public DeleteLesseeRecordPage(WebDriver driver) {
		this.driver = driver;
		util = new TestUtil(driver);
		commonFunction = new CommonFunction(driver);
	}
	
	By btnDelete = By.xpath("//input[contains(@id,'YALTITLESTAKEHOLDERS_radYALGridControl_ctl00_ctl04_gbcDeleteAlignment')]");
 ...
 public void ClickonCancle() 
 {
  ...
  public void ClickonOk() 
  {
     ...
     public void DeleteLesseeRecord(String testcaseName) {
	 util.dummyWait(10);
	 try {
		 ClickonDelete();
