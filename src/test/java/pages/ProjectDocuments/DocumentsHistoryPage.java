...
//			}
     ...
     if(util.isElementVisible(btnDeleteAllPriorVersion)) {
 	    try {
 		      ClickonDeleteAllButton();
	 			log("STEP 4: User can click on the Delete All Prior Version Button ", Status.PASS);
	 		 } catch (Exception e) {
	 			log("STEP 4: User cannot able to click on Delete All Prior Version Button ", Status.FAIL);
