...
public class PendingLegalFormPage extends BasePage{
	...
	public PendingLegalFormPage(WebDriver driver) {
		this.driver = driver;
...
//		 By txtDescriptionROW = By.xpath("//input[@id='RadPanelBar1_i0_i0_rauFileUploadDesc0']");
   ...
   By Iframe= By.xpath("//iframe[@name='ManageApprovalDialog']");
    ...
    public void PendingLegalForm(Map<String, String> map, String testcaseName) {
    
    	 if (testcaseName.contains("DOT") || testcaseName.contains("ALT")) {
