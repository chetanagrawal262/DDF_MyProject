...
public class DeleteRelocationInformationRecordPage extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String AGREEMENT_NUMBER;

	public DeleteRelocationInformationRecordPage(WebDriver driver) {
		this.driver = driver;
		util = new TestUtil(driver);
		commonFunction = new CommonFunction(driver);
	}
	
	By btnDelete = By.xpath("//input[contains(@id,'gridRELOCATIONSONinfoFILE_radYALGridControl_ctl00_ctl04_gbcDeleteAlignment')]");
	...
	public void DeleteRelocationInformationRecord(String testcaseName) {
		util.dummyWait(2);
		 try {
			 ClickonDeleteButton();
