...
public class ParcelSearch_CustomControlPage extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String tractNo;
	
	public ParcelSearch_CustomControlPage(WebDriver driver) {
		this.driver = driver;
	...
	By btnSaveParcel = By.xpath("//input[contains(@id,'_TractType_btnInternalSave')]");
	 ...
	 public void SelectSavedSearches(String value) {
	   ...
	   public void verifyParcelSearch(Map<String, String> map, String testcaseName) {
		   ...
		   try {
				...
				log("STEP 3:  user can navigate to Parcel search ", Status.PASS);
			} catch (Exception e) {
				log("STEP 3:   user cannot navigate to Parcel Search", Status.FAIL);
