...
public class ParcelInformation_AddNewParcelPage extends BasePage
{
    ...
    By btnaddParcel = By.xpath("//li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Add parcel'] | //li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Add Parcel'] | //li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Tract'] | //li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Document'] | //li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Parcel'] | //li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Add Tract'or text()='Parcel(Map/Lot)'] | //li[contains(@class,'rmItem rmFirst rmLast')]/..//*[text()='Location'] | //li[contains(@class,'rmItem rmFirst')]/..//*[text()='Tract']"); 
   ...
   // Step No 5
    ...
    By firstAcquisitionPriorityPopUp = By.xpath("//*[@id='TractType_Acquisition_type_ID_radYALDropDownList_DropDown']/..//li[1]");
    ...
    By firstPropertyTypePopUp = By.xpath("//*[@id='TractType_Property_Type_ID_radYALDropDownList_DropDown']/..//li[1]");
    ...
    public void addParcelNo(String value) {
		if (!commonFunction.checkNA(value))
			PARCEL_NUMBER =util.randomNumber();
			util.inputTextAndPressTab(txtParcelNo, PARCEL_NUMBER);
	}
    ...
    public void addParcelNoPopUp(String value) {
		if (!commonFunction.checkNA(value))
			PARCEL_NUMBER =util.randomNumber();
			util.inputTextAndPressTab(txtParcelNoPopUp, PARCEL_NUMBER);
	}
...
// 			util.inputTextAndPressTab(drpCounty, value);
 			util.inputText(drpCounty, value);
 		util.pressDownkey();
 		util.pressENTERkey();
 	}
    ...
    By firstTitleStatusPopUp = By.xpath("//*[@id='TractType_TITLE_STATUS_ID_radYALDropDownList_DropDown']/..//li[1]");
...
//			}
    ...
    By defaultValueNegotiationCategory = By.xpath("//span[text()='Negotiation Category']/..//input[@value='Select One']");
...
//            	selectAcquisitionPriority(map.get(Excel.AcquisitionPriority));
        ...
        if(testcaseName.contains("ROW") || testcaseName.contains("TRA") || testcaseName.contains("DOM"))
      {
    	...
    	try {
			...
			log("STEP 13: user can able to enter total tract acers     ", Status.PASS);
		} catch (Exception e) {
			log("STEP 13:  user not able to enter total tract acers     ", Status.FAIL);
			throw new RuntimeException("Failed in step 13");
		}
        	}
        try {
        	addComments(map.get(Excel.Comments));
			log("STEP 14: user can able to enter text in comment field    ", Status.PASS);
		} catch (Exception e) {
			log("STEP 14:  user not able to enter text in comment field   ", Status.FAIL);
      ...
      try {
        ...
        if(environment.contains("GRAYHAWKTCE")) {
        	try {
            	Assert.assertTrue(util.isElementVisible(defaultValueNegotiationCategory));
    			log("STEP 16: By Default 'Select One' value is displaying under the Negotiation Category DD", Status.PASS);
    		} catch (AssertionError e) {
    			log("STEP 16: Default value 'Select One' is not displaying under the Negotiation Category DD", Status.FAIL);
    		 }
        }
    }
