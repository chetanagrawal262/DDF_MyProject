...
public class AddProjectNotesPage extends BasePage{

	TestUtil util;
	CommonFunction commonFunction;
	public static String AGREEMENT_NUMBER;

	public AddProjectNotesPage(WebDriver driver) {
		this.driver = driver;
	...
	By btnAddNotesAlt = By.xpath("(//*[@id='ctl00_ConPHRightTop_RadPageView3']//img[@alt='Add Notes'])[1]");
    ...
    public void NavigateToProjectNotes() {
