...
public class MyDashboardTest extends BasePage{
	...
	public void verifyInboxMessage_TC_01() throws Exception {
		...
		objLogin.login(map);
		String testcaseName = "verifyInbox" + clientName;
	...
	public void addNewMessage_TC_04() throws Exception {
        ...
        String testcaseName = "AddNewMessage" + clientName;
		log("Data picked : " + testcaseName);
		map = ExcelUtils.getRowFromRowNumber(prop.getProperty(Excel.TOOL_TEST_DATA), Excel.MyDashboard, testcaseName);
	...
	/*
	 * @Test(priority = 5,enabled = false) public void requestDocument_TC_05()
	 * throws Exception { log("TC05 : Request Document :"); map =
	 * ExcelUtils.getRowFromRowNumber(prop.getProperty(Excel.LOGIN_TEST_DATA),
	 * Excel.Login, environment); String testcaseName = "AddNewMessage" +
	 * environment; log("Data picked : " + testcaseName); map =
	 * ExcelUtils.getRowFromRowNumber(prop.getProperty(Excel.TOOL_TEST_DATA),
	 * Excel.MyDashboard, testcaseName); objMyDashboard.addNewMessage(map,
	 * testcaseName); }
	 */
