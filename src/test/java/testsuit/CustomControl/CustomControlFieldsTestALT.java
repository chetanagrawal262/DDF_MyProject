...
public class CustomControlFieldsTestALT extends BasePage{
	...
	public void Custom_Control_LTEXT_TC_01() throws Exception {
		...
		map = ExcelUtils.getRowFromRowNumber(prop.getProperty(Excel.CUSTOM_CONTROL_TEST_DATA), Excel.CustomControlALT, testcaseName);
...
//	public void Parcel_Approval_Custom_Control_TC_21() throws Exception {
//		log("TC21 : Verify Custom Control Fields on Parcel Approval");
