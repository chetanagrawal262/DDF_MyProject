...
public class CustomControlFieldsTestROW extends BasePage{
	...
	public void Custom_Control_LTEXT_TC_01() throws Exception {
		...
		map = ExcelUtils.getRowFromRowNumber(prop.getProperty(Excel.CUSTOM_CONTROL_TEST_DATA), Excel.CustomControlROW, testcaseName);		
...
//	}
	...
	public void Custom_Control_RICHTEXT_TC_17() throws Exception {
		log("TC21 : verify RICHTEXT Custom Control field on the parcel details  ");
...
//	@Test(priority = 26,enabled = true)//Need update
